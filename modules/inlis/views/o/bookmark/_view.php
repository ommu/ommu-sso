...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('bookmark_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->bookmark_id), array('view', 'id'=>$data->bookmark_id)); ?>
	<br />
